...
const generateEditedItemString = function (editItemString) {
  const items = editItemString.replace((name) => generateItemElement(name));
  return ${editname};
};
...
const handleEditedItemName = function () {
$(".shopping-item-edit js-item-edit").on("click", function() {
